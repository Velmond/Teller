namespace Teller.Web.Controllers.Account
{
    using System;
    using System.Linq;
    ...
    public class AccountController : Controller
    {
        ...
        {
            var dbContext = new TellerDbContext();
            if (!ModelState.IsValid)
            {
                return this.View(model);
            }

            var userInDb = dbContext.Users.Where(u => u.UserName == model.Userame).FirstOrDefault();
            SignInStatus result;

            var isBanned = dbContext.Roles
                .Where(r => r.Name == GlobalConstants.BannedRoleName)
                .FirstOrDefault()
                .Users
                .Any(u => u.UserId == userInDb.Id);
            ...
            else
            {
                ...
                result = await this.SignInManager.PasswordSignInAsync(model.Userame, model.Password, model.RememberMe, shouldLockout: false);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // await this.UserManager.SendEmailAsync(user.Id, "Reset Password", "Please reset your password by clicking <a href=\string.Empty + callbackUrl + "\">here</a>");
